package mifos.authenticator.biometrics.windows

import mifos.authenticator.biometrics.mockServer.RegistrationDataGET
import mifos.authenticator.biometrics.mockServer.RegistrationDataPOST
import mifos.authenticator.biometrics.mockServer.RetrievedDataFromAuthenticator
import mifos.authenticator.biometrics.mockServer.VerificationDataGET
import mifos.authenticator.biometrics.mockServer.VerificationDataPOST
import mifos.authenticator.biometrics.mockServer.WindowsAuthenticationResponse
import com.mifos.passcode.mifos.authenticator.biometrics.mockServer.utils.generateBase64EncodedUID
import com.mifos.passcode.mifos.authenticator.biometrics.mockServer.utils.generateChallenge
import com.mifos.passcode.mifos.authenticator.biometrics.mockServer.utils.generateRandomUID

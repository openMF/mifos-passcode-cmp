...
class PlatformAuthenticationProvider(activity: Any? = null) {
     ...
     * This function directly delegates to the underlying [com.mifos.passcode.platformAuthenticator.PlatformAuthenticator].
     *
     ...
     * - [RegistrationResult.Success] The actual result from [com.mifos.passcode.platformAuthenticator.PlatformAuthenticator.registerUser] on success.
     ...
     * - [AuthenticationResult.Success] The actual result from [com.mifos.passcode.platformAuthenticator.PlatformAuthenticator.authenticate] on success.
     ...
     * already.
     * This function delegates directly to the underlying [com.mifos.passcode.platformAuthenticator.PlatformAuthenticator].
     */
